...
"Overworld": {
	...
	"Bag": {
		"Items 1":          [  0,  35,    48,  74],
		"Items 2":          [  0,  75,    49, 100],
		"Free space 1":     [ 49,   7,    94,  70],
		"Free space 2":     [ 49,  71,    57,  74],
		"Key items":        [ 58,  71,   108, 107],
		"Medicine":         [  0, 101,    38, 142],
		"TMs":              [ 39, 111,    70, 154],
		"Berries 1":        [ 67, 108,   106, 110],
		"Berries 2":        [ 71, 111,   106, 142],
	...
	"Bag item": {
		"Use":              [151,  71,   255,  95],
		"Give":             [151,  96,   255, 119],
		"Trash":            [151, 120,   255, 143],
		"Free space":       [151, 144,   255, 167],
		"Cancel":           [151, 168,   255, 191],
	},
	"Key item": {
		"Use":              [151,  95,   255, 119], // "Walk" when on bike
		"Register":         [151, 120,   255, 143],
		"Free space":       [151, 144,   255, 167],
		"Cancel":           [151, 168,   255, 191],
	},
	"TM item": {
	...
	"TM Teach": {
		...
		"Move 2":           [  7,  48,   143,  80],
		"Move 3":           [  7,  81,   143, 111],
		"Move 4":           [  7, 112,   143, 143],
		"Forget":           [  7, 159,   143, 191],
	...
	"Pokémon": {
		...
		"Register":         [183, 167,   206, 191],
		"Quit":             [207, 167,   222, 191],
	...
	"Options": {
		"Speed Slow":       [111,  23,   159,  47],
		"Speed Mid":        [160,  23,   207,  47],
		"Speed Fast":       [208,  23,   255,  47],
		"Scene On":         [111,  48,   183,  71],
		"Scene Off":        [184,  48,   255,  71],
		"Style Shift":      [111,  72,   183,  95],
		"Style Set":        [184,  72,   255,  95],
		"Sound Stereo":     [111,  96,   183, 119],
		"Sound Mono":       [184,  96,   255, 119],
		"IR Save":          [111, 120,   183, 143],
		"IR No Save":       [184, 120,   255, 143],
		"Register":         [ 47, 171,    71, 191],
		"Quit":             [ 79, 167,   103, 191],
		"Confirm":          [111, 167,   183, 191],
		"Cancel":           [184, 167,   255, 191],
		"Save Yes":         [151,  47,   255,  71],
		"Save No":          [151,  72,   255,  95],
	},
},
"C-Gear": {
	"C-Gear": {
		"Power":            [190, 170,   208, 188],
	},
	"Power": {
		"Yes":              [167,  47,   255,  71],
		"No":               [167,  72,   255,  95],
...
"Misc": { /* (nicknames, Pokéathlon, etc.) */
	"Fly": {
		...
		"Victory Road":     [178,  11,   191,  19],
		"Pokémon League":   [161,  10,   177,  18],
		"Lacunosa Town":    [181,  38,   197,  46],
		"Undella Town":     [215,  62,   231,  70],
		"Black City":       [181,  86,   197,  94],
		"Aspertia City":    [  5, 148,    21, 156],
		"Floccesy Town":    [ 24, 122,    40, 130],
		"Virbank City":     [ 60, 122,    76, 130],
		"Pokéstar Studios": [ 55, 110,    71, 118],
		"Lentimas Town":    [178,  62,   194,  70],
		"Humilau City":     [226,  31,   242,  39],
	...
	"Starters": {
		"Snivy":            [ 33,  63,    85, 115],
		"Tepig":            [102,  63,   153, 115],
		"Oshawott":         [173,  63,   225, 115],
		"Pick":             [ 71, 167,   182, 191],
